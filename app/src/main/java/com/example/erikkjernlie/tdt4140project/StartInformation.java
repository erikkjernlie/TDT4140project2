...
public class StartInformation extends AppCompatActivity {
    ...
    private void initVariables(){
        ...
        layouts = new int[]{
                R.layout.information1,
                R.layout.information2,
                R.layout.information3,
                R.layout.information4};
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(StartInformation.this, Menu.class));
        finish();
    }
